...
export const RegisterActions: React.FC<RegisterActionsProps> = ({
    step, totalSteps, loading, otpVerified, nextStep, prevStep
}) => {
    // Adım 4 (telefon doğrulama): OTP doğrulanana kadar ileri butonu gizlenir
    const isOtpStep = step === 4;
    const showNextButton = !isOtpStep || otpVerified;
