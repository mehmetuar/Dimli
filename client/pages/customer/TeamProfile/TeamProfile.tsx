...
export const TeamProfile: React.FC = () => {
    ...
    return (
        <div className="pb-28 pt-[4.5rem] px-4 max-w-3xl mx-auto min-h-screen bg-pitch relative">
            {/* Tab Switcher */}
            <div className="flex p-1 bg-slate-800 rounded-xl mb-8 border border-slate-700 sticky top-[4.5rem] z-40 shadow-lg">
                <button
