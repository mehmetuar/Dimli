    ...
    return (
        <div className="mb-6 flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            <button
                ...
                className={`flex items-center gap-2 px-4 py-3 rounded-xl font-bold text-sm transition-all border ${locationFilter.type !== 'ALL'
            ...
            >
                ...
                {locationFilter.type === 'NEARBY'
                    ? `Yakınımda (${locationFilter.radius}km)`
                    : locationFilter.type === 'DISTRICT'
