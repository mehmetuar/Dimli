...
import { X, AlertTriangle, ChevronRight, Eye, EyeOff, Trash2, Loader2 } from 'lucide-react';
...
export const DeleteModal: React.FC<DeleteModalProps> = ({ visible, loading, onClose, onConfirm }) => {
    ...
    const handleDelete = () => {
        ...
        setError('');
        onConfirm(selectedReason, note, password);
    };
    ...
    return (
        // paddingBottom: keyboardHeight → backdrop tam ekran kalır, kart klavyenin üstüne taşınır
        <div
                ...
                <div ref={scrollRef} className="flex-1 overflow-y-auto">
                    {step === 1 ? (
                        <div className="px-5 py-4 space-y-3">
                            <p className="text-slate-400 text-sm">İşletme hesabını silme sebebini seçer misin?</p>
                            ...
                            <div className="bg-red-950/40 border border-red-900/50 rounded-xl p-4 flex gap-3">
                                ...
                                <div>
                                    ...
                                    <ul className="text-slate-400 text-xs space-y-0.5 list-disc list-inside">
                                        <li>İşletme ve saha bilgilerin</li>
                                        <li>Aboneliğin</li>
                                        <li>Saha ayarların ve görsellerin</li>
                                    </ul>
