            ...
            <div className="w-full max-w-sm relative">
                ...
                <div className="relative bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 rounded-[2rem] overflow-hidden border-[3px] border-yellow-500/30 shadow-[0_0_40px_rgba(234,179,8,0.15)]">
                    ...
                    <div className="relative z-10 text-center mt-6 mb-4">
                        <h2 className="font-sport font-black text-[clamp(20px,7.5vw,36px)] text-white uppercase italic tracking-tighter drop-shadow-md !whitespace-nowrap overflow-hidden text-ellipsis">
                            {player.name}
                        </h2>
                    ...
                    <div className="relative z-10 px-6 pb-6">
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            ...
                            <div className="bg-white/5 rounded-xl p-2 sm:p-3 border border-white/10 flex flex-col items-center justify-center min-w-0">
                                ...
                                <span className="font-sport text-[clamp(10px,3.5vw,18px)] font-black text-white uppercase !whitespace-nowrap overflow-hidden text-ellipsis">{player.foot || '-'}</span>
                            </div>
                            {/* Position */}
                            <div className="bg-white/5 rounded-xl p-2 sm:p-3 border border-white/10 flex flex-col items-center justify-center min-w-0">
                                <span className="text-[clamp(8px,2.2vw,10px)] text-slate-400 font-bold uppercase mb-0.5">MEVKİ</span>
                                <span className="font-sport text-[clamp(10px,3.5vw,18px)] font-black text-white uppercase !whitespace-nowrap overflow-hidden text-ellipsis">{player.position}</span>
                            </div>
                            {/* Secondary Position */}
                            <div className="bg-white/5 rounded-xl p-2 sm:p-3 border border-white/10 flex flex-col items-center justify-center min-w-0">
                                <span className="text-[clamp(8px,2.2vw,10px)] text-slate-400 font-bold uppercase mb-0.5">YAN MEVKİ</span>
                                <span className="font-sport text-[clamp(10px,3.5vw,18px)] font-black text-slate-300 uppercase !whitespace-nowrap overflow-hidden text-ellipsis">{player.secondaryPosition || '-'}</span>
                            </div>
                        </div>
